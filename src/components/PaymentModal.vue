            ...
            <div class="w-full">
              ...
              <div class="mb-4 p-4 border rounded-lg bg-gray-50 font-mono text-sm">
                ...
                <div v-if="props.customer" class="mb-3">
                  <div>Cliente: {{ props.customer.razonSocial || `${props.customer.nombres} ${props.customer.apellidos}` }}</div>
              ...
              <div class="flex justify-between mt-6">
                <button 
                  ...
                  @click="printTicket"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="mt-4">
                <div class="mb-3">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
